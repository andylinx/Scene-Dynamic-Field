    ...
    def __init__(self, parameters = "7B"):
        ...
        if parameters == "7B":
            self.model = Qwen2VLForConditionalGeneration.from_pretrained(
                "/home/bingxing2/home/scx7l3k/linanxi/Qwen2-VL", torch_dtype="auto", device_map="auto",  local_files_only=True
            )
            self.processor = AutoProcessor.from_pretrained("/home/bingxing2/home/scx7l3k/linanxi/Qwen2-VL")
        elif parameters == "2B":
            self.model = Qwen2VLForConditionalGeneration.from_pretrained(

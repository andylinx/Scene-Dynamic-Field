...
from datasets.hd_utils import HD_transform_padding, HD_transform_no_padding
...
class VideoChat2:
    def __init__(self):
        self.model=AutoModel.from_pretrained("OpenGVLab/VideoChat2_HD_stage4_Mistral_7B_hf",trust_remote_code=True).to('cuda')
    ...
    def test_TCV(self, all_frames):
        ...
        video_path = "output_video_tmp.avi"  # Specify the output video file name
